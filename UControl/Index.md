...
* **RS485+CAN**：RS485和CAN，两者均配备120Ω终端电阻（用户可通过拨码开关手动关闭）。
* **PWM*4**：4路PWM输出。单推进载具，PWM1控制方向，PWM3控制推力。差速推进载具，PWM1控制右电机，PWM3控制左电机。
* **开关*4**：4路开关输出，用于控制警示灯、喇叭等。
* **天线*4**：4个SMA母头天线，其中2个用于连接蘑菇头天线，2个用于连接2.4G玻璃钢天线。
